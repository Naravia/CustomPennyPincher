...
namespace CustomPennyPincher
{
    public class PennyPincher : IDalamudPlugin
    {
        ...
        private void DrawWindow()
        {
            ...
            ImGui.InputInt("Percentage†", ref configMultiple);
            ImGui.TextWrapped("†A percentage of the [<lowest price>] after applying the delta (no effect if percentage is 100).");
